# (C)2004-2012 SourceMod Development Team
...
SDKBASE = ../../forbuild/
JANSSON = ./jansson-2.3.1/src/

SMSDK = $(SDKBASE)sourcemod-central
HL2SDK_ORIG = $(SDKBASE)hl2sdk
HL2SDK_OB = $(SDKBASE)hl2sdk-ob
HL2SDK_OB_VALVE = $(SDKBASE)hl2sdk-ob-valve
HL2SDK_L4D = $(SDKBASE)hl2sdk-l4d
HL2SDK_L4D2 = $(SDKBASE)hl2sdk-l4d2
MMSOURCE18 = $(SDKBASE)mmsource-1.8
...
INCLUDE += -I. -I.. -Isdk -I$(SMSDK)/public -I$(SMSDK)/public/sourcepawn -I$(JANSSON)
